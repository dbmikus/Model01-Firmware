...
KEYMAPS(
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   BUTTERFLY_KEY, Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   THUMB_KEYS_RIGHT,
   ShiftToLayer(FUNCTION)),
  ...
  (___,          Key_1,         Key_2,     Key_3,      Key_4, Key_5, Key_LEDEffectNext,
   ...
   BUTTERFLY_KEY,  Key_B, Key_M, Key_W, Key_V, Key_Z, Key_Equals,
   THUMB_KEYS_RIGHT,
   ShiftToLayer(FUNCTION)),
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   BUTTERFLY_KEY, Key_K, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   THUMB_KEYS_RIGHT,
   ShiftToLayer(FUNCTION)),
